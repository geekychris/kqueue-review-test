...
public class PaymentController {
    ...
    public ResponseEntity<Payment> createPayment(@RequestBody Map<String, Object> body) {
        ...
        // No input validation on amount (negative? zero? huge?)
        // No card number format validation
    ...
    public ResponseEntity<Payment> getPayment(@PathVariable Long id) {
        ...
        // Returns full card number in response
        return ResponseEntity.ok(payment);
    }
    ...
    public ResponseEntity<String> refundPayment(@PathVariable Long id) {
        // No authorization check - anyone can refund any payment
